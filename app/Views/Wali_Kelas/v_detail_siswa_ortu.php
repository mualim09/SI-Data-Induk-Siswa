                        ...
                        <div class="row mt-5">
                            <div class="col-12">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class=" nav-link active" aria-current="page" href="/wk/data_siswa/ortu/<?= $O['NISN']; ?>">Orang tua siswa</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="col-md-12">
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <?php foreach ($dataOrtu->getResultArray() as $O) : ?>
                                            <br>
                                            <div class="form-row">
                                                <div class="col ml-4">
                                                    <label for="formGroupExampleInput">Nama Ayah</label>
                                                    <input type="text" class="form-control col-md-12 mb-3" id="NAMA_AYAH" name="NAMA_AYAH" value="<?= $O['NAMA_AYAH']; ?>" readonly>
                                                </div>
                                                <div class=" col ml-5">
                                                    <label for="formGroupExampleInput">Nama ibu</label>
                                                    <input type="text" class="form-control col-md-10" id="NAMA_IBU" name="NAMA_IBU" value="<?= $O['NAMA_IBU']; ?>" readonly>
                                                </div>
                                            </div>

                                            <div class=" form-row">
                                                <div class="col ml-4">
                                                    <label for="formGroupExampleInput">Pendidikan Ayah</label>
                                                    <input type="text" class="form-control col-md-12 mb-3" id="PENDIDIKAN_AYAH" name="PENDIDIKAN_AYAH" value="<?= $O['PENDIDIKAN_AYAH']; ?>" readonly>
                                                </div>
                                                <div class=" col ml-5">
                                                    <label for="formGroupExampleInput">Pendidikan Ibu</label>
                                                    <input type="text" class="form-control col-md-10" id="PENDIDIKAN_IBU" name="PENDIDIKAN_IBU" value="<?= $O['PENDIDIKAN_IBU']; ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" form-row">
                                                <div class="col ml-4">
                                                    ...
                                                    <input type="text" class="form-control col-md-12 mb-3" id="PEKERJAAN_AYAH" name="PEKERJAAN_AYAH" value="<?= $O['PEKERJAAN_AYAH']; ?>" readonly>
                                                </div>
                                                <div class=" col ml-5">
                                                    <label for="formGroupExampleInput">Pekerjaan Ibu</label>
                                                    <input type="text" class="form-control col-md-10" id="PEKERJAAN_IBU" name="PEKERJAAN_IBU" value="<?= $O['PEKERJAAN_IBU']; ?>" readonly>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
