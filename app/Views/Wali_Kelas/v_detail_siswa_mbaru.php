                        ...
                        <div class="row mt-5">
                            <div class="col-12">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class=" nav-link active" aria-current="page" href="/wk/data_siswa/mbaru/<?= $O['NISN']; ?>">Murid baru</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="card shadow">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-10">
                                                <!-- Tabs -->
                                                <h5 class="card-title">Detail siswa baru</h5>
                                            </div>
                                        </div>

                                        <?php foreach ($dataMbaru->getResultArray() as $O) : ?>
                                            <br>
                                            <div class="form-row">
                                                <div class="col ml-4">
                                                    <label for="formGroupExampleInput">Asal Murid</label>
                                                    <input type="text" class="form-control col-md-12 mb-3" id="ASAL_MURID" name="ASAL_MURID" value="<?= $O['ASAL_MURID']; ?>" readonly>
                                                </div>
                                                <div class=" col ml-5">
                                                    <label for="formGroupExampleInput">Nama TK</label>
                                                    <input type="text" class="form-control col-md-10" id="NAMA_TK" name="NAMA_TK" value="<?= $O['NAMA_TK']; ?>" readonly>
                                                </div>
                                            </div>

                                            <div class=" form-row">
                                                <div class="col ml-4">
                                                    <label for="formGroupExampleInput">Nomor STTB</label>
                                                    <input type="text" class="form-control col-md-12 mb-3" id="NOMOR_STTB" name="NOMOR_STTB" value="<?= $O['NOMOR_STTB']; ?>" readonly>
                                                </div>
                                                <div class=" col ml-5">
