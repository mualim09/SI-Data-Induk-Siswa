                        ...
                        <div class="row mt-5">
                            <div class="col-12">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class=" nav-link active" aria-current="page" href="/wk/data_siswa/mpindahan/<?= $O['NISN']; ?>">Murid pindahan</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="card shadow">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-10">
                                                <!-- Tabs -->
                                                <h5 class="card-title">Detail siswa pindahan</h5>
                                            </div>
                                        </div>

                                        <?php foreach ($dataMpindahan->getResultArray() as $O) : ?>
                                            <br>
                                            <div class="form-row">
                                                <div class="col ml-4">
                                                    <label for="formGroupExampleInput">Asal Sekolah</label>
                                                    <input type="text" class="form-control col-md-12 mb-3" id="ASAL_SEKOLAH" name="ASAL_SEKOLAH" value="<?= $O['ASAL_SEKOLAH']; ?>" readonly>
                                                </div>
                                                <div class=" col ml-5">
                                                    <label for="formGroupExampleInput">Kelas</label>
                                                    <input type="text" class="form-control col-md-10" id="TINGKAT_KELAS" name="TINGKAT_KELAS" value="<?= $O['TINGKAT_KELAS']; ?>" readonly>
                                                </div>
                                            </div>

                                            <div class=" form-row">
                                                <div class="col ml-4">
                                                    <label for="formGroupExampleInput">Tanggal penerimaan</label>
                                                    <input type="text" class="form-control col-md-12 mb-3" id="TGL_PENERIMAAN" name="TGL_PENERIMAAN" value="<?= $O['TGL_PENERIMAAN']; ?>" readonly>
                                                </div>
                                                <div class=" col ml-5">
                                                    <input type="hidden" class="form-control col-md-10" id="PENDIDIKAN_IBU" name="PENDIDIKAN_IBU" value="<?= $O['PENDIDIKAN_IBU']; ?>" readonly>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
