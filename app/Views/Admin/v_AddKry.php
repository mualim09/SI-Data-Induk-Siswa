                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" id="Txtnik" name="Txtnik" class="form-control Txtnik <?= ($validation->hasError('Txtnik')) ? 'is-invalid' : ''; ?>" placeholder="masukan nomor induk kependudukan sesuai KTP" value="<?= old('Txtnik'); ?>" required>

                                                <div class="invalid-feedback">
                                                    <?= $validation->getError('Txtnik'); ?>
                                                </div>
                                            </div>
                                            <div class="form-group mb-3">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-7">
                                                        ...
                                                        <input type="text" id="txtIdKry" name="txtIdKry" minlength="4" class="form-control txtIdKry" value="<?= old('txtIdKry'); ?>" placeholder="Masukan ID Unik (Min 4 Digit)">
                                                    </div>
                                                    <div class="col-md">
                                                        <label for="txtPwKry">Password : </label>
                                                        <input type="password" id="txtPwKry" name="txtPwKry" minlength="8" class="form-control txtPwKry" placeholder="Masukan Password (Min 8 Digit)" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
