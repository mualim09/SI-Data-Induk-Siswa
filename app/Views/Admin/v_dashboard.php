                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col pr-0">
                        ...
                        <span class="h3 mb-0"><?= $JumSiswa; ?> Siswa</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col pr-0">
                        ...
                        <span class="h3 mb-0"><?= $JumGuru; ?> Pengajar</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col pr-0">
                        ...
                        <span class="h3 mb-0"><?= $JumKls; ?> Kelas</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div id="chart-box">
                          <hr>
                          <?php foreach ($Jumall->getResultArray()  as $Jumall) : ?>
                            <!-- Item 1 -->
                            <div class="row align-items-center my-3">
                              <!-- Nama Item -->
                              <div class="col">
                                <strong>Kelas Tinggkat <?= $Jumall['NAMA_KELAS']; ?></strong>
                                <!-- <div class="my-0 text-muted small">Global, Services</div> -->
                              </div>
                              <!-- txt Presentase -->
                              <div class="col-auto">
                                <strong><?= $Jumall['Jumall']; ?> Kelas</strong>
                              </div>
