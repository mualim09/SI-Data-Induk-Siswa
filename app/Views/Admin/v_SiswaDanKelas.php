        ...
        <main role="main" class="main-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="page-title">Siswa Dan Kelas</h2>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="varyModalLabel">Tambah Keals Baru</h5>
                                                            ...
                                                            <form action="/adm/snk/save">
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label for="recipient-name" class="col-form-label">Pilih Wali kelas</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="recipient-name" class="col-form-label">Pilih kelas Baru</label>
                                                                        <select id="txtIdKelas" name="txtIdKelas" class="form-control">
                                                                            <?php foreach ($DataKls->getResultArray()  as $DataKls) : ?>
                                                                                <option value="<?= $DataKls['ID_KELAS']; ?>"><?= $DataKls['NAMA_KELAS']; ?></option>
                                                                            <?php endforeach; ?>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php foreach ($Q_Sub_KelasModel->getResultArray()  as $DataKelas) : ?>
                                                    <tr>
                                                        <td><?= $DataKelas['Nama Kelas']; ?></td>
                                                        <td><?= $DataKelas['Nama Sub kelas']; ?></td>
                                                        <td><?= $DataKelas['Nama Wali kelas']; ?></td>
                                                        <td><a class="btn mb-2 btn-secondary btn-sm" href="/adm/snk/<?= $DataKelas['ID_SUB_KLS']; ?>">Lihat Detail</a></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
