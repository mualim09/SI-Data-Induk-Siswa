                                                ...
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php foreach ($DataEksul->getResultArray()  as $DataEksul) : ?>
                                                            <tr class="d-flex">
                                                                <td class="col-1"><?= $i++; ?></td>
                                                                <td class="col-6"><?= $DataEksul['NAMA_EKSUL']; ?></td>
                                                                <td class="col"><?= $DataEksul['NILAI_EKSUL']; ?></td>
                                                                <td class="col-2"><?= $DataEksul['KETERANGAN_EKSUL']; ?></td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    </tbody>
                                                </table>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="/C_Admin/AddEksul/<?= $idNISN; ?>/<?= $idSemesterPilih; ?>">
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Email address</label>
                                    <select class="form-control txtIDEksul" id="txtIDEksul" name="txtIDEksul">
                                        <?php foreach ($EkskulList->getResultArray()  as $EkskulList) : ?>
                                            <option value="<?= $EkskulList['ID_EKSUL']; ?>"><?= $EkskulList['NAMA_EKSUL']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="NILAI_EKSUL">Nilai Ekstrakurikuler</label>
                                    <input type="number" class="form-control" id="NILAI_EKSUL" name="txtNilaiEksul" placeholder="Masukan Nilai Ekstrakurikuler">
                                </div>
                                <div class="form-group">
                                    <label for="Ket">Nilai Ekstrakurikuler</label>
                                    <input type="text" class="form-control" id="Ket" name="txtKeteragan" placeholder="Masukan Deskripsi Nilai">
                                    <input type="hidden" class="form-control" id="idSmster" name="idSmster" value="<?= $idSemesterPilih; ?>" placeholder="Masukan Deskripsi Nilai">
                                    <input type="hidden" class="form-control" id="nisnek" name="nisnek" value="<?= $idNISN; ?>" placeholder="Masukan Deskripsi Nilai">
                                </div>
                            </div>
