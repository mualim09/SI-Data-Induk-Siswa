                                        ...
                                        <table class="table datatables" id="dataTable-1">
                                            ...
                                            <tbody>
                                                <?php foreach ($DataKry->getResultArray()  as $DataKry) : ?>
                                                    <tr>
                                                        <!-- <td> <img src="/assets/image/FotoKry/<?= $DataKry['nik']; ?>.jpg" alt="..." width='50px' class="avatar-img rounded-circle"></td> -->
                                                        <!-- <td><?= $DataKry['nik']; ?></td> -->
                                                        <td><?= $DataKry['NAMA_KRY']; ?></td>
                                                        <td><?= $DataKry['NAMA_JABATAN']; ?></td>
                                                        <td><?= $DataKry['JK_KRY']; ?></td>
                                                        <td><?= $DataKry['TELP_KRY']; ?></td>
                                                        <td><?= $DataKry['Tgl_Lahir']; ?></td>
                                                        <!-- <td><?= $DataKry['ALAMAT_KRY']; ?></td> -->
                                                        <td><a type="button" class="btn btn-outline-primary bt-sm" href="/adm/kry/detail/<?= $DataKry['ID_KARYAWAN']; ?>">Lihat Detail</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <a class="btn btn-outline-primary mr-1" href="/adm/kry/add/JB_003">Tamabah Guru (Wali Kelas)</a>
                            <!-- <a  class="btn btn-outline-primary mr-1" href="/adm/kry/add/(:segment)">Tamabah Guru Mata Pelajaran</a> -->
                            <a class="btn btn-outline-primary mr-1" href="/adm/kry/add/JB_001">Tamabah Admin</a>
